...
"")
        ...
        self.label.setGeometry(QRect(200, 20, 111, 18))
...
"")
        ...
        self.label_3.setGeometry(QRect(110, 130, 61, 10))
...
"font-weight: bold")
        ...
        self.label_alerta.setObjectName("label_erro")
        self.label_alerta.setGeometry(QRect(110, 261, 280, 20))  # Ajuste a posição e tamanho
        self.label_alerta.setStyleSheet("color: red; font-weight: bold;")
        self.label_alerta.setText("")

        self.label_5 = QLabel(Dialog)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(110, 200, 41, 10))
...
"")
        ...
        self.pushButton_3.setGeometry(QRect(270, 260, 121, 23))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Bem-vindo!", None))
        self.label_2.setText("")
        self.pushButton_2.setText(QCoreApplication.translate("Dialog", u"Entrar", None))
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("Dialog", u"Digite seu Nome", None))
        self.lineEdit_2.setPlaceholderText(QCoreApplication.translate("Dialog", u"Digite seu Senha", None))
        ...
        self.pushButton_3.setText(QCoreApplication.translate("Dialog", u"Esqueceu a Senha ?", None))
    # retranslateUi
